...
import com.bicubic.camerademo2.Utility.BitmapHelper;
...
//    private Bitmap bitmap;
    ...
    protected void onPostExecute(Bitmap bitmap) {
        ...
        if(context instanceof MainActivity && FLAG_DECODE_BITMAP){
            ((MainActivity)context).decodeBitmapComplete(bitmap);
        }
    }
